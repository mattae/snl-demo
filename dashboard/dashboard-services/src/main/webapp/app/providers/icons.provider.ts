...
export const provideIcons = (): Array<Provider | EnvironmentProviders> => {
    return [
        provideEnvironmentInitializer(() => {
            ...
            matIconRegistry.addSvgIconSetInNamespace('priority', domSanitizer.bypassSecurityTrustResourceUrl('static/icons/priority.svg'));
            matIconRegistry.addSvgIconSetInNamespace('mime', domSanitizer.bypassSecurityTrustResourceUrl('static/icons/mime-types.svg'));
        })
    ];
};
